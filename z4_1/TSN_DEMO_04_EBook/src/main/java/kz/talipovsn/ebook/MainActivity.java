...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            idTopic = savedInstanceState.getInt(ID_TOPIC, R.id.lec1);
        } else {
            ...
            idTopic = sPref.getInt(ID_TOPIC, R.id.lec1);
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        // Блок выбора тем
        if (id == R.id.lec1) {
            webView.loadUrl(resourceDir + "lec1.html");
        } else if (id == R.id.lec2) {
            webView.loadUrl(resourceDir + "lec2.html");
        } else if (id == R.id.lec3) {
            webView.loadUrl(resourceDir + "lec3.html");
        } else if (id == R.id.lec4) {
            webView.loadUrl(resourceDir + "lec4.html");
        } else if (id == R.id.lec5) {
            webView.loadUrl(resourceDir + "lec5.html");
        } else if (id == R.id.lec6) {
            webView.loadUrl(resourceDir + "lec6.html");
        } else if (id == R.id.lec7) {
            webView.loadUrl(resourceDir + "lec7.html");
            // Блок внешних переходов
        } else {
            if (id == R.id.nav_view1) { // Переход на внешнюю html-ссылку и внешний браузер
                openLinkExternally(getString(R.string.drive2));
            }
            if (id == R.id.nav_view2) { // Переход на внешнюю html-ссылку и внешний браузер
                openLinkExternally(getString(R.string.niva_wiki));
            }
            if (id == R.id.nav_view3) { // Переход на внешнюю html-ссылку и внешний браузер
                openLinkExternally(getString(R.string.chevy_niva));
            }
